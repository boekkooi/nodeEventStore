...
Store.prototype = {
    ...
    createSnapshot: function(streamId, revision, data, callback) {
        ...
        var snapshot = new Store.Snapshot(null, streamId, revision, data);
    ...
    getEventStream: function(streamId, revMin, revMax, callback) {
        ...
        this.storage.getEvents(streamId, revMin, revMax, function(err, events) {
            if (err) {
                ...
                callback(null, new Store.EventStream(self, streamId, events));
            }
        });
...
EventStream.prototype = {
    ...
    addEvent: function(event) {
        var evt = new Store.Event(this.streamId, event);
